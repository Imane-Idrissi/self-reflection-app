            ...
            <div className="flex items-start justify-between gap-md">
              ...
              {!skipped && report && (
                <button
                  ...
                  className="print:hidden shrink-0 mt-md flex items-center gap-xs rounded-md bg-primary-500 px-md py-sm text-small font-medium text-text-inverse shadow-sm transition-all duration-[150ms] ease-out hover:bg-primary-600 hover:shadow-md active:bg-primary-700 disabled:bg-primary-200 disabled:text-primary-600 disabled:shadow-none disabled:cursor-not-allowed"
                >
