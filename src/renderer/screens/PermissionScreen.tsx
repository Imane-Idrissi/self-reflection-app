      ...
      <div className="w-full max-w-[520px]">
        ...
        <div className="flex gap-sm">
          ...
          <button
            ...
            disabled={loading}
            className="flex-1 flex items-center justify-center rounded-md bg-primary-500 px-lg py-[12px] text-body font-medium text-text-inverse shadow-sm transition-colors duration-[150ms] ease-out hover:bg-primary-600 active:bg-primary-700 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
              <svg
